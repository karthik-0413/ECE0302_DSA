...
// *****************************************
//	USING GIVEN LINKED LIST IMPLEMENTATION *
// *****************************************
...
void LinkedList<T>::insert(std::size_t position, const T& item)
{
	...
	// Throwing exceptions in insert function as per the instructions
	else
	{
		throw std::range_error("Nothing to insert");
	}
} //end insert
...
void LinkedList<T>::remove(std::size_t position)
{
	...
	// Throwing exceptions in remove function as per the instructions
	else
	{
...
T LinkedList<T>::getEntry(std::size_t position) const
{
	...
	// Throwing exceptions in getEntry function as per the instructions
	else
	{
...
void LinkedList<T>::setEntry(std::size_t position, const T& newValue)
{
	...
	// Throwing exceptions in setEntry function as per the instructions
	else
	{
		throw std::range_error("Nothing to setEntry");
	}
} //end setEntry
